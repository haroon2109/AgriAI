...
MODEL_PATH = os.path.join(MODEL_DIR, "disease_mobilenetv2.pth")
BATCH_SIZE = 16
EPOCHS = 5 # Short run for demo

def train_disease_model():
    print("[INFO] Starting MobileNetV2 Disease Model Training...")
    ...
    # Transforms
    # MobileNetV2 expects 224x224 usually
    ...
    # We're predicting Risk Level (High / Low) which maps to Stressed / Healthy based on classes
    ...
    print(f"[INFO] MobileNetV2 Model saved to {MODEL_PATH}")
